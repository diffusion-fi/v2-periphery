...
task('deploy-router', 'Deploys UniswapV2Router02 contract').setAction(async (args, hre) => {
...
task('deploy-multicall2', 'Deploys Multicall2 contract').setAction(async (args, hre) => {
